...
SAFE_DURATION_SECONDS = 1500   # 🛡️ 撤離防線：25 分鐘 (1500秒)。提早於 app.py 的 30 分鐘暴力中斷，確保優雅下班
# =========================================================
...
def run_stt_to_summary_mission(sb=None):
    ...
    for intel in tasks:
        ...
        # 🚀 拔除副檔名防禦：只跳過空包彈，允許 .mp3 等格式進入 Gemini 摘要！
